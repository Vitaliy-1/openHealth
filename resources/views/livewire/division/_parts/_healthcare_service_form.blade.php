        ...
        <x-forms.forms-section-modal submit="{{ $mode }}">
            <x-slot name='form'>
                        ...
                        <x-forms.form-group class=''>
                            <x-slot name='label'>
                                <x-forms.label for='speciality_type' class='default-label'>
                                    {{ __('forms.speciality_type') }}
                                </x-forms.label>
                            </x-slot>
                            <x-slot name='input'>
                                <x-forms.select
                                    {{-- x-bind:disabled="{{ empty($formService->getHealthcareServiceParam('category')) }}" --}}
                                ...
                                >
                                    <x-slot name='option'>
                                        <option value=''>
                                            {{ __('forms.select') }} {{ __('forms.speciality_type') }}
                                        </option>
                ...
                <div class='mb-4 mt-4'>
                    ...
                    @nonempty($formService->getHealthcareServiceParam('available_time'))
                        @foreach ($formService->getHealthcareServiceParam('available_time') as $k => $a_time)
                            ...
                            <div class='grid grid-cols-4 gap-4 mb-5' x-data='{ disabled : false }'>
                ...
                <div class='mb-4 mt-4'>
                    ...
                    @nonempty($formService->getHealthcareServiceParam('not_available'))
                        @foreach ($formService->getHealthcareServiceParam('not_available') as $k => $not_time)
