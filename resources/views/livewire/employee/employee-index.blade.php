                ...
                <div class="flex items-center mb-4 sm:mb-0">
                    <x-forms.form-group class="sm:pr-3 о">
                        ...
                        <x-slot name="input" class="max-w-2xs">
                            <x-forms.select class="default-input" wire:model="selectedOption"
                                wire:change="sortEmployees()" type="text" id="owner_position">
                                <x-slot name="option">
    ...
    <div class="overflow-x-auto">
        <div class="inline-block min-w-full align-middle">
            <div class="shadow">
                        ...
                        @nonempty($employees->items())
                            ...
                            @foreach ($employees as $k => $employee)
                                <tr>
                                    ...
                                    <td class="text-center border-b border-[#eee] py-5 px-4 ">
                                    ...
                                    <td x-data="{ open: false }" class="text-center border-b border-[#eee] py-5 px-4 ">
                                        @if ($employee->email)
                ...
                <x-pagination :pagination="$employees" class="pagination" style="margin-block-start: -80px;" />
            </div>
        </div>
    </div>
