        ...
        'healthcare_service' => [
            ...
            'error' => [
                ...
                'in_dictionary' => [
                    ...
                    'speciality_type' => 'Вказаного типу спеціальності не існує'
                ],
                'constraint' => [
                    'category' => 'Така послуга вже є для цієї категорії',
                    'category_pharmacy' => 'Категорія PHARMACY вже використовується у цьому місці надання послуг',
                    'providing_condition' => 'Така послуга вже є для цього місця надання послуг',
                ],
                'time' => [
                    'available' => 'Закінчення часу доступності менше часу початку',
                    'not_available' => 'Кінцева дата часу недоступеності менше початкової'
                ]
            ]
        ],
        'license' => [
